...
def sort_data(raw_data_list):
    ...
    tuple_sorted_data = namedtuple('sorted_data', ['time_list', 'lat_list', 'lon_list', \
                                                    'speed_list', 'Hacc_list', 'Hdop_list', \
                                                    'QoS_list', 'sat_list', 'iai_list', \
                                                    'HR_list', 'Acc_X_list', 'Acc_Y_list', \
                                                    'Acc_Z_list', 'Gyr_X_list', 'Gyr_Y_list', \
                                                    'Gyr_Z_list'])
    sorted_data = tuple_sorted_data(time_list, lat_list, lon_list, speed_list, Hacc_list, Hdop_list, \
